...
const Productsdata = () => {
  ...
  return (
      ...
      <div className="container py-4">
        <div className="text-center heading-feature"><h3 >Featured Products</h3>
        <Image  src={Line} alt="line" /></div>
        <div className="row align-items-center  column-gap mobile-res">
        {data.map((item) => {
          return (
          <div className="col-12 col-sm-6 col-md-4 col-lg-2 pt-3 ">
            <div className="card card-style card-shadow">
              ...
              <h6 className="prod-heading">{item.heading}</h6>
                <div className="d-flex justify-content-between card-typography">
                  <div className="gap-3">
                    <span className="fw-bold price">$14.99</span>
                    <Image
                      src={item.rating}
                      alt=""
                      layout="responsive"
